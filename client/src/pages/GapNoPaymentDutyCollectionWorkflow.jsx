...
/**
 * Gap/CFS Feature Page: No payment/duty-collection workflow.
 * Slug: no-payment-duty-collection-workflow
 * Backend: /api/gap-no-payment-duty-collection-workflow
 */
export default function NoPaymentDutyCollectionWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-duty-collection-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No payment/duty-collection workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No payment/duty-collection workflow.</p>
