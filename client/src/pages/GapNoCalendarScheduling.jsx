...
/**
 * Gap/CFS Feature Page: No calendar / scheduling.
 * Slug: no-calendar-scheduling
 * Backend: /api/gap-no-calendar-scheduling
 */
export default function NoCalendarSchedulingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-calendar-scheduling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No calendar / scheduling.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No calendar / scheduling.</p>
