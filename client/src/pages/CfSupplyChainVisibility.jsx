...
/**
 * Gap/CFS Feature Page: Supply chain visibility
 * Slug: supply-chain-visibility
 * Backend: /api/cf-supply-chain-visibility
 */
export default function SupplyChainVisibilityPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-supply-chain-visibility', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Supply chain visibility</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track shipments through customs; alert on delays/compliance issues.</p>
