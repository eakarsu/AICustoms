...
/**
 * Gap/CFS Feature Page: Automation of declarations
 * Slug: automation-of-declarations
 * Backend: /api/cf-automation-of-declarations
 */
export default function AutomationOfDeclarationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-automation-of-declarations', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Automation of declarations</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-generate customs declarations from purchase orders and shipping data.</p>
