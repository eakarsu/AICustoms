...
/**
 * Gap/CFS Feature Page: No SMS / push notifications.
 * Slug: no-sms-push-notifications
 * Backend: /api/gap-no-sms-push-notifications
 */
export default function NoSmsPushNotificationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sms-push-notifications', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No SMS / push notifications.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No SMS / push notifications.</p>
