...
/**
 * Gap/CFS Feature Page: Sanctions-screening agent
 * Slug: sanctions-screening-agent
 * Backend: /api/cf-sanctions-screening-agent
 */
export default function SanctionsScreeningAgentPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-sanctions-screening-agent', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Sanctions-screening agent</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Continuous monitoring of parties against multiple sanctions lists with explainable hits.</p>
