...
/**
 * Gap/CFS Feature Page: `documents` lacks AI declaration auto-generation.
 * Slug: documents-lacks-ai-declaration-auto-generation
 * Backend: /api/gap-documents-lacks-ai-declaration-auto-generation
 */
export default function DocumentsLacksAiDeclarationAutoGenerationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-documents-lacks-ai-declaration-auto-generation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`documents` lacks AI declaration auto-generation.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`documents` lacks AI declaration auto-generation.</p>
