...
/**
 * Gap/CFS Feature Page: Tariff & compliance optimization
 * Slug: tariff-compliance-optimization
 * Backend: /api/cf-tariff-compliance-optimization
 */
export default function TariffComplianceOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-tariff-compliance-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Tariff & compliance optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict optimal tariff codes; minimize duties while maintaining compliance.</p>
