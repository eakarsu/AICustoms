...
/**
 * Gap/CFS Feature Page: No webhooks for carrier or government API pushes.
 * Slug: no-webhooks-for-carrier-or-government-api-pushes
 * Backend: /api/gap-no-webhooks-for-carrier-or-government-api-pushes
 */
export default function NoWebhooksForCarrierOrGovernmentApiPushesPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhooks-for-carrier-or-government-api-pushes', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No webhooks for carrier or government API pushes.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No webhooks for carrier or government API pushes.</p>
