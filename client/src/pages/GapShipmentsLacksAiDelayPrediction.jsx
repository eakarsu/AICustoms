...
/**
 * Gap/CFS Feature Page: `shipments` lacks AI delay-prediction.
 * Slug: shipments-lacks-ai-delay-prediction
 * Backend: /api/gap-shipments-lacks-ai-delay-prediction
 */
export default function ShipmentsLacksAiDelayPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-shipments-lacks-ai-delay-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`shipments` lacks AI delay-prediction.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`shipments` lacks AI delay-prediction.</p>
